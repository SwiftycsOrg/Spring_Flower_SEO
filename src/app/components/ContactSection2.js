import { Target, Zap, TrendingUp, Shield, Mail, Phone, Building, User, CheckCircle , Star, Users} from 'lucide-react';
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <h1 className=" text-4xl sm:text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-gray-900 via-teal-700 to-blue-800 bg-clip-text text-transparent">
             Training Science & Machine Learning
          </h1>
          <p className="text-xl md:text-2xl mb-16  text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Unlock the power of data with our comprehensive training programs designed for real-world applications and career advancement.
          </p>
        </div>
      </div>
    </section>
 ...
 function ConsultationForm() {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Boost your career with in-demand data skills."
    },
    // {
  ...
  >
    <div className="text-center mb-4">
      ...
      <p className="text-gray-600 text-base">
        Join Swiftycs Academy and embark on a rewarding career in Data Science and Machine Learning. Fill out the form below to get started!
    ...
    <div className="space-y-2 flex-grow">
      ...
      <textarea
        name="message"
        placeholder="Tell us about your learning goals and current experience..."
        rows="3"
